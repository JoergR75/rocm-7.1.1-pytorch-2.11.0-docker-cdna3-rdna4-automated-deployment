...
install_jellyfish() {
    ...
    python3 -m pip install torch torchvision --index-url https://download.pytorch.org/whl/rocm7.1 --no-input
...
install_noble() {
    ...
    pip3 install torch torchvision --index-url https://download.pytorch.org/whl/rocm7.1 --no-input --break-system-packages
